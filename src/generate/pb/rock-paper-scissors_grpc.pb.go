...
type RockPaperScissorsServiceClient interface {
	// ジャンケンを行います。
	PlayGammmm(ctx context.Context, in *PlayRequest, opts ...grpc.CallOption) (*PlayResponse, error)
	// 対戦結果の履歴を確認します。
...
func (c *rockPaperScissorsServiceClient) PlayGammmm(ctx context.Context, in *PlayRequest, opts ...grpc.CallOption) (*PlayResponse, error) {
	out := new(PlayResponse)
	err := c.cc.Invoke(ctx, "/proto.RockPaperScissorsService/PlayGammmm", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rockPaperScissorsServiceClient) ReportMatchResults(ctx context.Context, in *ReportRequest, opts ...grpc.CallOption) (*ReportResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.RockPaperScissorsService/ReportMatchResults", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RockPaperScissorsServiceServer interface {
	// ジャンケンを行います。
	PlayGammmm(context.Context, *PlayRequest) (*PlayResponse, error)
	// 対戦結果の履歴を確認します。
...
func (UnimplementedRockPaperScissorsServiceServer) PlayGammmm(context.Context, *PlayRequest) (*PlayResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PlayGammmm not implemented")
}
...
func _RockPaperScissorsService_PlayGammmm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PlayRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RockPaperScissorsServiceServer).PlayGammmm(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.RockPaperScissorsService/PlayGammmm",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RockPaperScissorsServiceServer).PlayGammmm(ctx, req.(*PlayRequest))
	}
...
func _RockPaperScissorsService_ReportMatchResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.RockPaperScissorsService/ReportMatchResults",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var RockPaperScissorsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.RockPaperScissorsService",
	HandlerType: (*RockPaperScissorsServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PlayGammmm",
			Handler:    _RockPaperScissorsService_PlayGammmm_Handler,
		},
		{
